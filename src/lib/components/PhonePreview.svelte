...
<style>
  ...
  .phone { position: relative; display: block; width: min(82vw, 17rem, 39svh); aspect-ratio: 1 / 2; padding: 8px; overflow: hidden; border: 0; border-radius: 2.65rem; color: var(--gray-800); background: var(--gray-900); box-shadow: 0 1.25rem 3rem color-mix(in srgb, var(--primary-500) 18%, var(--transparent)); cursor: pointer; font: inherit; text-align: left; touch-action: pan-y; user-select: none; -webkit-user-select: none; }
  ...
  .step.active, .step.done { color: var(--white); background: var(--primary-500); box-shadow: 0 2px 5px var(--primary-200); }
  ...
  .event-card { display: grid; grid-template-columns: 2.7rem 1fr 1rem; gap: .65rem; align-items: center; margin-bottom: .65rem; padding: .85rem .7rem; border: 1px solid var(--primary-200); border-radius: .85rem; background: color-mix(in srgb, var(--primary-500) 5%, var(--white)); box-shadow: 0 3px 10px color-mix(in srgb, var(--primary-500) 8%, var(--transparent)); }
  .muted-card { border-color: var(--gray-200); background: var(--white); box-shadow: none; }
  .event-date { display: grid; height: 2.7rem; place-content: center; border-radius: .6rem; color: var(--white); background: var(--primary-500); text-align: center; line-height: 1; }
  ...
  .radio.selected { border: 4px solid var(--primary-500); }
  .continue { display: flex; width: 100%; flex: 0 0 auto; box-sizing: border-box; align-items: center; justify-content: space-between; margin-top: auto; padding: .72rem .9rem; border: 0; border-radius: .7rem; color: var(--white); background: var(--primary-500); font-size: .68rem; font-weight: 700; box-shadow: 0 5px 12px color-mix(in srgb, var(--primary-500) 24%, var(--transparent)); cursor: pointer; }
  ...
  .dancer-row.selected { border-color: var(--primary-200); background: color-mix(in srgb, var(--primary-500) 5%, var(--white)); box-shadow: 0 3px 10px color-mix(in srgb, var(--primary-500) 8%, var(--transparent)); }
  ...
  .dancer-name small { margin-top: .18rem; color: var(--primary-500); font-size: .52rem; text-decoration: underline; }
